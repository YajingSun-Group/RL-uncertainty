...
class RJTPPO(PPO):  # type: ignore
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        '''
        策略熵超参数,熵(entropy)是信息论中的一个概念,
        在强化学习中通常用来度量策略的随机性或不确定性.熵越大,
        表示策略的选择越随机,熵越小,则表示策略的选择越确定.
        在强化学习中,尤其是与策略梯度方法(如PPO, A3C)相关的算法中,
        熵用于鼓励智能体保持策略的探索性，避免过早地收敛到局部最优解.
        在策略优化过程中,如果没有熵正则化,策略可能会变得过于确定
        (即趋向于"贪婪"),导致探索不足.
        '''
