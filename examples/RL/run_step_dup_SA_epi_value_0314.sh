...
CONFIG_YAML=$SCRIPT_DIR/config_SA_label1_1000_epi_value_0314.yaml ##
DATASET_DIR=$TOP_DIR/data
MODEL_DIR=$TOP_DIR/GNN_finetune_model
OUTDIR=$TOP_DIR/results/SA_label1_1000_epi_value_0314/ ##
...
$PYTHON $TOP_DIR/scripts/rl/train_ppo.py \
    ...
    > $OUTDIR/SA_epi_value_0314.log 2>&1 ##

END_TIME=$(date +%s)
ELAPSED_TIME=$((END_TIME - START_TIME))
echo "Script execution time: $ELAPSED_TIME seconds" >> $OUTDIR/SA_epi_value_0314.log ##